    ...
    <div class="lg:sticky lg:top-20">
        ...
        <div class="">
            ...
            <div class="mt-4 flex flex-col gap-4">
                <div @click="openLink(category.link)"
                    ...
                    :class="THEME_ARRAY[index % THEME_ARRAY.length]" v-for="(category, index) in categories"
                    :key="category.name">
                    <div>
        ...
        <!-- 随机一言 -->
        <div class="mt-4 rounded-lg bg-amber-100 bg-text-card px-2 py-2 shadow-md dark:bg-amber-950/80"
