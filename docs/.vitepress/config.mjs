...
export default defineConfig({
  ...
  // 网站描述，有利于被搜索引擎捕获
  description:
    "BlowsBreeze's tech blog: An postgraduate's journey through frontend development, sharing insights, tips, and experiences in web technologies.",
  ...
  themeConfig: {
    ...
    // 顶部导航栏左侧的社交平台跳转
    socialLinks: [{ icon: "github", link: "https://github.com/BlowsBreeze" }],
    // 首页底部版权声明
    footer: {
